...
import ru.ifmo.service.ClpSerializer;
...
public class DocumentClp extends BaseModelImpl<Document> implements Document {
	...
	public void setDlDocumentId(long dlDocumentId) {
		...
		if (_documentRemoteModel != null) {
			try {
				...
				method.invoke(_documentRemoteModel, dlDocumentId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setStatus(int status) {
		...
		if (_documentRemoteModel != null) {
			try {
				...
				method.invoke(_documentRemoteModel, status);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setStatusByUserId(long statusByUserId) {
		...
		if (_documentRemoteModel != null) {
			try {
				...
				method.invoke(_documentRemoteModel, statusByUserId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setStatusByUserName(String statusByUserName) {
		...
		if (_documentRemoteModel != null) {
			try {
				...
				method.invoke(_documentRemoteModel, statusByUserName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setStatusDate(Date statusDate) {
		...
		if (_documentRemoteModel != null) {
			try {
				...
				method.invoke(_documentRemoteModel, statusDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	private Class<?> _clpSerializerClass = ru.ifmo.service.ClpSerializer.class;
}