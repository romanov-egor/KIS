...
public class DocumentLocalServiceClp implements DocumentLocalService {
	...
	public ru.ifmo.model.Document addDocument(ru.ifmo.model.Document document)
		...
		return (ru.ifmo.model.Document)ClpSerializer.translateOutput(returnObj);
	}
	...
	public ru.ifmo.model.Document deleteDocument(long documentId)
		...
		try {
			...
			if (t instanceof ru.ifmo.NoSuchDocumentException) {
				throw (ru.ifmo.NoSuchDocumentException)t;
			}
	...
	public java.util.List<ru.ifmo.model.Document> getDocuments(int start,
		...
		return (java.util.List<ru.ifmo.model.Document>)ClpSerializer.translateOutput(returnObj);
	}
